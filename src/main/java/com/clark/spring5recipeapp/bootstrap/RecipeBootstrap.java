package com.clark.spring5recipeapp.bootstrap;

import com.clark.spring5recipeapp.domain.*;
import com.clark.spring5recipeapp.repositories.CategoryRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        log.debug("RecipeBootstrap - getRecipies");
